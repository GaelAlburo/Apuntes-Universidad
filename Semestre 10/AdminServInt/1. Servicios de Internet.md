Un **servicio** es un componente reutilizable independiente (no necesita interfaz) y debil que permite la prestacion de este sin importar la aplicacion que lo usa
